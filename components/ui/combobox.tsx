...
function ComboboxItem({
  ...
  return (
    <ComboboxPrimitive.Item
      ...
      render={<PillDropdownItem />}
      className={cn(
        "cursor-default gap-2 pr-8 outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >

/**
 * @file page.tsx
 * @description Intercepted modal version of the cart page; loads the user's cart and renders CartPanel.
 *   Called by: Next.js parallel route (@modal) when navigating client-side to /cart

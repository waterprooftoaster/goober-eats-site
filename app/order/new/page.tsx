 ...
 *   Checks auth and passes isGuest to OrderNewForm. For guests, also fetches
 *   the schools list so they can select which school to order from (auth users
 *   have a profile.school_id resolved server-side at checkout time).
 *   Both guest and authenticated users can access.
...
import { OrderNewForm, type SchoolOption } from './order-new-form'
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      <div className="mx-auto max-w-xl px-4 py-8">
        ...
        <OrderNewForm isGuest={isGuest} schools={schools} />
      </div>
    </main>
  )
}
